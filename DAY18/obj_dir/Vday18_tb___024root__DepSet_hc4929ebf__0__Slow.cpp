...
VL_ATTR_COLD void Vday18_tb___024root___eval_initial__TOP(Vday18_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vday18_tb___024root___eval_initial__TOP\n"); );
    // Init
    VlWide<3>/*95:0*/ __Vtemp_1;
    // Body
    __Vtemp_1[0U] = 0x2e766364U;
    __Vtemp_1[1U] = 0x61793138U;
    __Vtemp_1[2U] = 0x64U;
...
VL_ATTR_COLD void Vday18_tb___024root___eval_triggers__stl(Vday18_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vday18_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vday18_tb___024root___eval_triggers__stl\n"); );
    // Body
